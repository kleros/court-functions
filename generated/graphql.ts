...
export enum Activity_OrderBy {
  ...
  JurorTotalStakedAllCourts = 'juror__totalStakedAllCourts',
...
export type Juror = {
  ...
  rewards: Array<Reward>;
  stakes: Array<Stake>;
  totalStakedAllCourts: Scalars['BigInt']['output'];
...
export type Juror_Filter = {
  ...
  totalStakedAllCourts?: InputMaybe<Scalars['BigInt']['input']>;
  totalStakedAllCourts_gt?: InputMaybe<Scalars['BigInt']['input']>;
  totalStakedAllCourts_gte?: InputMaybe<Scalars['BigInt']['input']>;
  totalStakedAllCourts_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  totalStakedAllCourts_lt?: InputMaybe<Scalars['BigInt']['input']>;
  totalStakedAllCourts_lte?: InputMaybe<Scalars['BigInt']['input']>;
  totalStakedAllCourts_not?: InputMaybe<Scalars['BigInt']['input']>;
  totalStakedAllCourts_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export enum Juror_OrderBy {
  ...
  Rewards = 'rewards',
  Stakes = 'stakes',
  TotalStakedAllCourts = 'totalStakedAllCourts',
...
export enum Round_OrderBy {
  ...
  SubcourtTotalStaked = 'subcourt__totalStaked',
  Votes = 'votes',
...
export type DisputeQuery = { __typename?: 'Query', dispute?: { __typename?: 'Dispute', metaEvidenceId: any, createdAtBlock: any, arbitrated: { __typename?: 'Arbitrable', id: any }, arbitrableHistory?: { __typename?: 'ArbitrableHistory', metaEvidence: string } | null } | null };
